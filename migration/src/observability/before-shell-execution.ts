...
if (match) {
  ...
  process.stdout.write(JSON.stringify({
    permission: 'deny',
    agentMessage: `Blocked: '${command}' matches a merge/direct-push pattern. Per ADR-015, no agent may merge or force-push. This list is defense-in-depth behind migration-pr-drafter's missing terminal. Let a human merge.`,
  }));
} else {
